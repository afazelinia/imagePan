...
var ImageViewer = /** @class */ (function (_super) {
    ...
    function ImageViewer() {
        ...
        _this.positionX = 0;
        _this.animatedPositionX = new Animated.Value(0);
        // 上次/当前/动画 y 位移
        _this.lastPositionY = null;
        _this.positionY = 0;
        _this.animatedPositionY = new Animated.Value(0);
        // 缩放大小
        _this.scale = 1;
        _this.animatedScale = new Animated.Value(1);
        ...
        _this.panResponderReleaseResolve = function () {
            ...
            if (_this.props.enableCenterFocus && _this.scale < 1) {
                // 如果缩放小于1，强制重置为 1
                _this.scale = 1;
                Animated.timing(_this.animatedScale, {
                    toValue: _this.scale,
                    duration: 100
                }).start();
            }
            if (_this.props.imageWidth * _this.scale <= _this.props.cropWidth) {
                // 如果图片宽度小于盒子宽度，横向位置重置
                _this.positionX = 0;
                Animated.timing(_this.animatedPositionX, {
            ...
            if (_this.props.imageHeight * _this.scale <= _this.props.cropHeight) {
                // 如果图片高度小于盒子高度，纵向位置重置
                _this.positionY = 0;
                Animated.timing(_this.animatedPositionY, {
    ...
    ImageViewer.prototype.render = function () {
        ...
        var parentStyles = StyleSheet.flatten(this.props.style);
        return (<View style={__assign({}, image_zoom_style_1.default.container, parentStyles, { width: this.props.cropWidth, height: this.props.cropHeight })} {...this.imagePanResponder.panHandlers}>
